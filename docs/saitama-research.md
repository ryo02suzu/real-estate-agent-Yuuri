...
| 川越市 | ✕（市道のみ） | wagmap 道路台帳・網図 | ✅ 確認済み | 建設管理課 049-224-5987 |
...
| 入間市 | ✕ | — | — | 開発建築課 04-2964-1111（代表） |
| 朝霞市 | ◎ 全種別（公道・私道とも） | wagmap 建築基準法道路 mid=120 | ✅ 確認済み（**世界測地系**） | 開発建築課 048-463-2585 |
| 三郷市 | ✕ | — | — | 建築指導係 048-930-7743 |
| 戸田市 | △ 市道のみ | いいとだマップ 道路路線図 | ✕ 入口のみ | 建築住宅課 048-441-1800 |
| 深谷市 | ✕ | — | — | 建築住宅課 048-574-6655（**窓口のみ**） |
| 鴻巣市 | ✕ | — | — | 建築住宅課（**窓口のみ**、先に道路課で査定確認） |
| ふじみ野市 | ✕ | — | — | 建築指導係 049-220-2069 |
| 富士見市 | △ 位置指定道路のみ | 図面番号から選ぶPDF | ✕ 入口のみ | 建築指導課 |
| 加須市 | ✕ | — | — | 建築開発課 0480-62-1111（代表） |
| 坂戸市 | ✕ | — | — | 建築指導担当（問い合わせ方法は未調査） |

## 技術メモ

- **wagmap は自治体ごとに受け取る測地系が違う**。越谷・上尾・熊谷・川越は旧日本測地系（変換しないと北西に約450mずれる）、朝霞は世界測地系（変換すると南東に約450mずれる）。いずれも市役所の住所で中心一致を確認済み。新しい wagmap 自治体を追加するときは必ず両方試すこと。
